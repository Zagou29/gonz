...
export class Affimg {
  ...
  #frg_images; // Fragment où charger les img
  #frg_dates; // Element où charger les liensdates
  ...
  #preparerImages() {
    this.#frg_images = new DocumentFragment();
    let n = 0;
    let vseuil = "";
  ...
  #preparerImagesPhoto(vseuil) {
    ...
    this.#listimg.forEach((obj, index) => {
      ...
      this.#frg_images.append(image.retourImage);
      vseuil = obj.an;
    });
  }
   ...
   */
  #preparerDates() {
    this.#frg_dates = new DocumentFragment();
    ...
    if (this.#opt === "photo") {
      ...
      this.#listimg.forEach((obj) => {
        if (obj.seuil !== "") {
          ...
          this.#frg_dates.append(lien_date.retourDateItem);
        }
      });
    } else {
  ...
  creeimages(ancre_imgs) {
    ...
    this.#ancre_imgs.append(this.#frg_images);
    return this;
  }
  ...
  creedates(ancres_dates) {
    ...
    this.#ancres_dates.append(this.#frg_dates);
    return this;
  }
}
